...
<div class="hidden h-screen flex-col bg-indigo-50 md:flex">
	...
	<main class="flex min-h-0 flex-1">
		...
		<aside
			class="flex w-80 shrink-0 flex-col gap-4 overflow-hidden border-l border-indigo-100 bg-white p-4 lg:w-96"
		>
			<div
				bind:this={previewEl}
				onclick={() => {
			...
			<div class="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto">
				...
				<a
					...
					class="mt-auto self-end text-xs font-medium text-slate-400 transition hover:text-indigo-500"
				>
